...
const FloatingContact = () => {
  ...
  const phoneNumber = '+918690761918';
  const whatsappNumber = '8690761918';
  ...
  return (
    <div className="fixed right-6 bottom-6 z-50">
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute bottom-28 right-0 bg-white rounded-2xl shadow-2xl p-4 w-64 transform transition-all duration-300 ease-in-out">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-3 bg-pink-50 hover:bg-pink-100 p-3 rounded-xl transition-all duration-200"
              >
                <div className="bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 rounded-full p-2 flex-shrink-0">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 text-white fill-current">
        ...
        <button
          ...
          className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
